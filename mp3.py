...
class CoverartMetadata:
    def __init__(
            self,
            video_id: str = None,
            coverart_target_url: str = None,
            nocrop: bool = False,
            timestamp: datetime.time = datetime.time(0, 0, 1)):
        self.nocrop = nocrop
        self.video_id = video_id
        self.coverart_target_url = coverart_target_url
